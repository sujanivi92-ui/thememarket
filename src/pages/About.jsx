...
// import { Search, Users, Download, Tag, Globe, Target, Eye, Star } from "lucide-react";
...
//             {[
//               { icon: <Users className="text-green-600" size={26} />, label: "50K+", text: "Active Users" },
//               { icon: <Download className="text-green-600" size={26} />, label: "2.5M+", text: "Downloads" },
//               { icon: <Tag className="text-green-600" size={26} />, label: "15K+", text: "Products" },
//               { icon: <Globe className="text-green-600" size={26} />, label: "150+", text: "Countries" },
//             ].map((item, i) => (
//               <div
//                 key={i}
